...
class UserController extends Controller
{
    ...
    public function show(User $user,$id)
    {
        ...
        return view('admin.users_show',['data'=>$data,'datalist'=>$datalist]);
    }
    ...
    {
        $data = User::find($id);
        return view('admin.users_edit',['data'=>$data]);
    }
    ...
    public function user_roles(User $user,$id){
        $data = User::find($id);
        $datalist = Roles::all()->sortBy('name');
        return view('admin.users_roles',['data'=>$data,'datalist'=>$datalist]);
